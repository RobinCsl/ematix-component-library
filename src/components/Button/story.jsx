...
storiesOf("Buttons", module).add("Buttons", () => (
  <div className="storybook-template">
    <h1 className="storybook-title">Buttons</h1>
    ...
    <h2 className="storybook-sub-title">Size Props</h2>
    <p>xs, lg</p>

    <h2 className="storybook-sub-title">As Link</h2>
    <p>to, href</p>
    <h2 className="storybook-sub-title">Common Buttons</h2>
    <h3>xs</h3>
